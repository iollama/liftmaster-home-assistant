...
pcbLength           = 60; // Front to back
pcbWidth            = 40; // Side to side
pcbThickness        = 1.6;
...
standoffHeight      = 7.0;  //-- used only for pushButton and showPCB
...
renderQuality       = 30;        //-> from 1 to 32, Default = 8
onLidGap            = 2;
shiftLid            = 15;
colorLid            = "gray";   
alphaLid            = 1;//0.2;   
...
//-------------------------------------------------------------------
pcbStands = [
  [2.35, 2.35, yappHole, yappBaseOnly, yappAllCorners]
];
...
cutoutsLid  = 
[
   [ 25, 21, 10, 10, 8, yappCircle, undef, 0, yappCenter],
   [ 10, 8,  7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ 10, 23, 7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ 10, 38, 7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ 10, 53, 7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ -5, 8,  7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ -5, 23, 7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ -5, 38, 7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ -5, 53, 7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ -20, 8,  7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ -20, 23, 7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ -20, 38, 7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ -20, 53, 7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ 45, 8,  7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ 45, 23, 7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ 45, 38, 7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ 45, 53, 7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ 28, 38, 7, 7, 2, yappRoundedRect, undef, 45, yappCenter],
   [ 28, 53, 7, 7, 2, yappRoundedRect, undef, 45, yappCenter],   
